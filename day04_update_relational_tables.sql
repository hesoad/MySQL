...
constraint urun_tablosu_Fk foreign key (tedarikci_id)
...
select * from puanlar;
/*-------------------------------------------------------------------------
5) Tum cocuklarin gradelerini  puanlar  tablosundaki yazili notu ile update edin. 
--------------------------------------------------------------------------*/
update cocuklar 
...
--------------------------------------------------------------------------*/
update puanlar
set yazili_notu=(select grade from cocuklar where isim ='Rumeysa Aydin')
...
--------------------------------------------------------------------------*/
update puanlar
set yazili_notu=(select grade from cocuklar where isim= 'Resul Can')
...
-- 3) Ismi A ile  baslayanlarin urun_fiyatlarini %15 artirin 
